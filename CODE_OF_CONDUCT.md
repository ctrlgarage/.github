...
CtrlGarage community a harassment-free experience for everyone, regardless of age,
...
requests, and discussions under [`@ctrlgarage`](https://github.com/ctrlgarage) — and
also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to
the maintainers at **[aleksandar@ctrlgarage.dev](mailto:aleksandar@ctrlgarage.dev)**.
